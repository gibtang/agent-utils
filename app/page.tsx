      ...
      <nav className="fixed top-0 w-full z-50 bg-space-black/80 backdrop-blur-md border-b border-border-subtle">
        <div className="flex items-center justify-between px-[var(--spacing-gutter)] py-4 max-w-[var(--spacing-container-max)] mx-auto">
          ...
          <div className="flex items-center gap-4">
            {/* Mobile nav links */}
            <Link href="/docs" className="md:hidden text-sm text-on-surface-variant hover:text-primary transition-colors py-3 px-1">
              Docs
            </Link>
            <a
              ...
              aria-label="GitHub"
              className="hidden sm:flex items-center gap-2 text-on-surface-variant hover:text-primary transition-all active:opacity-80 p-3"
            >
