 ...
 *
 * Redirects to /dashboard when already authenticated. On successful signup the
 * AuthProvider provisions the hidden tenant + auto-creates a first API key
 * (surfaced once on the dashboard).
 */
    ...
    <main className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-16">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-2 text-center text-sm text-on-surface-variant">
          Get an API key in seconds — free
        </p>
        ...
        <p className="mt-6 text-center text-sm text-on-surface-variant">
          ...
          <Link href="/login" className="font-medium text-primary-fixed-dim hover:underline">
            Sign in
          </Link>
        </p>
      </div>
