    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-900 p-8 shadow-xl">
        ...
        <form onSubmit={handleEmailSignIn} className="space-y-4">
          ...
          <div className="relative">
            <input
              ...
              required
              className="w-full rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-2.5 pr-10 text-sm text-zinc-100 placeholder-zinc-500 focus:border-zinc-500 focus:outline-none"
            />
            <button
              type="button"
          ...
          <div className="flex justify-end">
            <button
              ...
              className="text-xs text-zinc-400 hover:text-zinc-200 transition-colors min-h-[44px] px-2 flex items-center"
            >
              Forgot password?
            </button>
          </div>
        ...
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-2.5 text-sm font-medium text-zinc-100 hover:bg-zinc-700 transition-colors disabled:opacity-50"
        >
        ...
        <p className="mt-6 text-center text-sm text-zinc-400">
          ...
          <a href="/signup" className="text-zinc-200 underline hover:text-white min-h-[44px] px-2 inline-flex items-center">Create one</a>
        </p>
      </div>
    </div>
  );
