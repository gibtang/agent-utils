...
const publicPaths = ['/', '/pricing', '/api/webhooks', '/api/auth', '/api/health', '/docs', '/llms.txt', '/hook', '/f', '/login', '/signup', '/api/firebase-config', '/api/user', '/approve', '/api/checkpoint/public', '/v1', '/c', '/api/c'];
